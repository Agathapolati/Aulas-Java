...
public class Data {
	...
	public void imprimir(int formato) {
		...
		if (hora == -1) {
			...
			// Monta parte da string do horário (deixa a hora de fora por enquanto)
			String horario = ":" + minuto + ":" + segundo;
			
			if (formato == FORMATO_24H) {
				// Se o formato for 24h, concacetena a hora no inicio da string (o atributo  já foi  fornecido no formato 24h)
				...
				if (hora == 0 ) {
					...
					// Se a hora for menor que 12,utiliza a própria hora e concatena o "AM" no fim.
					horario = hora + horario;
					horario += " AM";
				}
			}
