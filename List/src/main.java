...
public class main {
	...
	public static void main(String[] args) {
		...
		lista.add("abc"); // add recebe o Objeto, ou seja, qualquer coisa.
		lista.add(12);
		lista.add(true); 

//		for (int x = 0; x < lista.size(); x++) { // size: tamanho do Array list,  intera enquanto a condição for verdadeira
//			System.out.println(lista.get(x)); // o get recebe o index(índice) (da onde está o valor que você quer).
//		}
		...
		List<Conta> listaDeContas = new ArrayList<Conta>(); // só aceita os objetos do tipo Conta (classe), Para usar o Generic usa:<>

		listaDeContas.add(conta1); // Adicionou a Conta 1 e 2
		listaDeContas.add(conta2);
		for (Conta conta : listaDeContas) { // Recebe as 2  contas
